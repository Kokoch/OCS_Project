...
do  
    ...
    do
        ...
        do  
            ...
            perf stat -a -e "power/energy-pkg/","power/energy-ram/","cpu/cache-misses/" -o ./java/outputs/perf_output${i}.txt java java/matrix ${s} $range ${t}
            python3 data_write_java.py $size $range ${t} $language ${i}
